...
const Register = () => {
  ...
  return (
    ...
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <Container className="mt-5" style={{position: 'relative', zIndex: "2", color:"white !important"}}>
      <Row>
        ...
        <Col md={{ span: 6, offset: 3 }}>
          <h2 className="text-center" style={{ color: "#ff9800" }}>Registration</h2>
          <Form>
            <Form.Group controlId="formBasicName" className="mt-3">
              <Form.Label style={{ color: "#ffcc80" }}>Name</Form.Label>
              <Form.Control
                type="text"
                name="name"
            ...
            <div style={{width: "100%", display: "flex", alignItems:"center", justifyContent:"center", flexDirection: "column"}} className="mt-4">
              ...
              <p className="mt-3" style={{ color: "#ffcc80" }}>
                Already have an account? <Link to="/login" style={{ color: "#ff9800", textDecoration: "none" }}>Login</Link>
              </p>
            </div>
          </Form>
        </Col>
